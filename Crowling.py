...
class crowling_rasff_details:
    def __init__(self, page_number, rasff_part):
    ...
    def rasff(self):
        ...
        RASFF_Measures_taken = pd.DataFrame(
            columns=["REFERENCE", "COUNTRY", "ACTION_RA", "PRODUCT_NAME", "URL"]
        )
        ...
        for u in range(page_number):
            for p in range(1, last_number):  # items per page
                try:
                ...
                if "subject" in self.rasff_part:
                    ...
                    Risk_decision = driver.find_element(
                        By.XPATH,
                        '//*[@id="main-additional"]/div[1]/app-nt-item[1]/div/p/span',
                    ).text
                    ...
                    if u == (page_number - 1) and p == (last_number - 1):

                        filename_Subject = f"RASFF_Subject_by_Hwang.xlsx"
                ...
                if "risk" in self.rasff_part:
                    ...
                    if u == (page_number - 1) and p == (last_number - 1):
                        ...
                        filename_Risk = f"RASFF_Risk_by_Hwang.xlsx"
                ...
                if "organisations" in self.rasff_part:
                    ...
                    if u == (page_number - 1) and p == (last_number - 1):
                        filename_Organisations = f"RASFF_Organisation_by_Hwang.xlsx"
                ...
                if "measure taken" in self.rasff_part:
                    ...
                    if u == (page_number - 1) and p == (last_number - 1):
                        filename_Measures_taken = f"RASFF_Measures_taken_by_Hwang.xlsx"
                ...
                if "follow ups" in self.rasff_part:
                    ...
                    if u == (page_number - 1) and p == (last_number - 1):
                        filename_Follow_ups = f"RASFF_Follow_ups_by_Hwang.xlsx"
                ...
                if "products" in self.rasff_part:
                    ...
                    try:
                        ...
                        try:
                            ...
                            hazard_text = products.find_element(
                                By.XPATH,
                    ...
                    if u == (page_number - 1) and p == (last_number - 1):
                        filename_Products = f"RASFF_Products_by_Hwang.xlsx"
                ...
                if "hazards" in self.rasff_part:
                    ...
                    if u == (page_number - 1) and p == (last_number - 1):
                        filename_Hazards = f"RASFF_Hazards_by_Hwang.xlsx"
